...
if (isset($_POST['submit'])) {
  ...
  $namaMhsw = $_POST["nama"];
  $nimMhsw = $_POST["nim"];
  $jurusanMhsw = $_POST["jurusan"];
  $angkatanMhsw = $_POST["angkatan"];

  $query = "INSERT INTO tb_student (nama, nim, jurusan, angkatan) VALUES ('$namaMhsw', '$nimMhsw', '$jurusanMhsw', '$angkatanMhsw')";
